...
insert into productos values (42,'proyecto hector',9999,1,1);
...
insert into lugares_entrega (longitud, latitud, direccion) values (42,42, 'almacen 47 modificar');
insert into lugares_entrega (longitud, latitud, direccion) values (74,74, 'almacen 47 eliminar');
...
insert into camiones (matricula, id_estado_c, id_marca_modelo, volumen_max_l, peso_max_kg) values ('a47a',47,47,99,99), ('a42a',42,42,99,99), ('a74a',74,74,99,99);
...
insert into usuarios (id, nombre_de_usuario, contrasenia) values (47,'usuario a listar','aaa'), (42,'usuario a modificar','bb'), (74,'usuario a eliminar','cc');
...
insert into mail_usuarios (id_usuarios,mail) values (47,'listar@mail.com'), (42,'modificar@mail.com'), (74,'eliminar@mail.com');

/* inserts pruebas unitarias choferes*/
insert into choferes (id_usuarios, licencia_de_conducir) values (47,'lic list'), (42,'lic mod'), (74,'lic del');
